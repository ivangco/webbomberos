$(document).ready(function() {
    ...
    $('.btn-acounts-area').on('click', function() {
        var acountsArea = $('.acounts-area');
        if (acountsArea.css('opacity') == "0") {
            acountsArea.addClass('show-acount-area');
        } else {
            acountsArea.removeClass('show-acount-area');
        }
...
(function($) {
    $(window).on("load", function() {
        ...
        $(".dashboard-contentPage, .acounts-body").mCustomScrollbar({
            theme: "dark-thin",
            scrollbarPosition: "inside",
            autoHideScrollbar: true,
            scrollButtons: { enable: true }
