...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="listadoclciente.php">bombero <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <section class="row m-0 bg-white justify-content-center align-items-center vh-100">
        <div class="col-sm-8 bg-white">
            <h1 class="text-center">Editar bombero</h1>
            <!--formulario-->
            <form class="container-fluid center-block bg-white " action="php/modificarbombero.php" method="GET">
                <div class="row">
                    ...
                    <div class="col-12">
                        <label>Nombre</label>
                        <input type="text" class="form-control" name="nombre_bombero" id="nombre_bombero"
                            value="<?php echo $row['nombre_persona'];?>">
                    </div>
                    <div class="col-12">
                        <label>Apellido</label>
                        <input type="text" class="form-control" name="apellido_bombero" id="apellido_bombero"
                            value="<?php echo $row['apellido_persona'];?>">
                    </div>
                    <div class="col-12">
                        <label>Documento</label>
                        <input type="text" class="form-control" name="documento_bombero" id="documento_bombero"
                            value="<?php echo $row['documento_persona'];?>">
                    </div>
                    <div class="col-12">
                        <label>Direccion</label>
                        <input type="text" class="form-control" name="direccion_bombero" id="direccion_bombero"
                            value="<?php  echo $row['direccion_persona'];?>">
                    </div>
                    <div class="col-12">
                        <label>Telefono</label>
                        <input type="text" class="form-control" name="telefono_bombero" id="telefono_bombero"
